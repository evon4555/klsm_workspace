# Membership Card Module Index

Module purpose:

- Website membership card purchase or binding, membership benefits, member-only
  ticketing rules, and member identity validation.
...
|---|---|---|---|---|---|
| none | none | no-standalone-package | none | No standalone membership-card date package has been created yet. | Create the first membership-card date package when a membership-card source change needs analysis, design, review, execution, or release tracking. |
