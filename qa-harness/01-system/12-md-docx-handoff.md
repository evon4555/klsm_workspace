...
- `04-test-case-review/test-case-review-*.md` (Test Manager final
  sign-off)
- `06-execution-review/test-report-*.md` or
  `06-execution-review/execution-review-*.md` (QA readiness review shared
  with stakeholders)
...
- For `04-test-case-review/` and `06-execution-review/test-report-*.md`, the
