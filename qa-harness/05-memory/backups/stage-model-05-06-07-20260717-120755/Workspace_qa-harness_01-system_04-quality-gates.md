...
## [SECTION] Gate 5: Release Ready

Before release approval, these conditions should be met:
...
- Quality owner or release owner records the final decision.

If this gate is not passed:

- Delay release, reduce scope, fix defects, or record formal risk acceptance.

---

## [SECTION] Gate 6: Post-Release Closed
