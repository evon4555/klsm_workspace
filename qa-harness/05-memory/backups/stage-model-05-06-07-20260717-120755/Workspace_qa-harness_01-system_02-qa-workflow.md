...
QA summarizes execution status, quality conclusion, known risks, and release recommendation.
...
## [SECTION] 10. Release Quality Review

Before release, stakeholders should review whether the quality gate is satisfied.
...
**Use:** [templates/release-quality-checklist.md](./02-templates/release-quality-checklist.md). The decision is recorded as a Pass/Fail/Conditional sign-off backed by `01-system/03-tools/gate.py` output for the latest harness state.

---

## [SECTION] 11. Post-Release Monitoring

After release, QA and the project team should monitor production quality.
...
| 10. Release review | — | `release-quality-checklist` |
| 11. Post-release monitor | `analyze-production-bug` | `production-bug-analysis-template` |
