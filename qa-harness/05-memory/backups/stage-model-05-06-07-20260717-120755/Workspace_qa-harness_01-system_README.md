...
- [`test-report-template.md`](./02-templates/test-report-template.md) — release-time report.
...
- [`release-quality-checklist.md`](./02-templates/release-quality-checklist.md) — release readiness review.
...
stage (01-input … 06-release) with a status badge derived from real
artifacts on disk.
...
- No release should proceed without a clear quality conclusion and known risk list.
