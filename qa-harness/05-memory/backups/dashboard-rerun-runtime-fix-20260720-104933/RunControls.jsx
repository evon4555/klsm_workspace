...
export default function RunControls({
  ...
  const scopeTitle = `Current scope: ${scopeLabel}`
  ...
  return (
    ...
    >
      <Row gutter={[12, 12]} align="middle">
        ...
        <Col>
          <Tooltip title="Reruns failed cases from the selected full run. The Test Case dropdown does not change this scope.">
            <Button
              icon={<ReloadOutlined />}
