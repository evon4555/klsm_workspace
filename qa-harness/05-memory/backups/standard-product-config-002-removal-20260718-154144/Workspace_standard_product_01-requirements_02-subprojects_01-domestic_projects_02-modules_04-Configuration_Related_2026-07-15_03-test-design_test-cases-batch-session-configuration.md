...
| Current Status | Test Manager signed off; post sign-off scope adjustment removed unnecessary save-failure case `SIT-TC-STD-CONFIG-015` |
...
|----|----|----|----|
| None | No open test-design review point after the 2026-07-17 scope adjustment. | N/A | Proceed with the 14 current-scope cases. |
