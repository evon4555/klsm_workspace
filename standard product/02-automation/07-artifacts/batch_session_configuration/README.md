...
Dashboard run `200` passed all 13 current-scope cases and is linked to
`case-screenshot-manifest-run-200.json`.

Runs `190` and `194` are retained as superseded audit evidence. Run `190` did
not prove API state transition, and run `194` still included removed case
