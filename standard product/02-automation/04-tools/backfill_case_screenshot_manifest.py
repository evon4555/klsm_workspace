...
# Legacy-only mapping for historical run 176 backfill. Do not use this helper
# for current manifests; current manifests are produced by the Behave runtime
# and exclude removed cases such as SIT-TC-STD-CONFIG-002 and
# SIT-TC-STD-CONFIG-015.
CASES = {
