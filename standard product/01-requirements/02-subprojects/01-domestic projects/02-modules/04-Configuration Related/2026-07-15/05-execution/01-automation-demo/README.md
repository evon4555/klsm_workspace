...
5. If no scenario gap is found, create or update
   `05-execution/02-automation-assessment/automation-assessment-batch-session-configuration.xlsx` from
   `01-source-documents/02-templates/AutomationAssessment_Template.xlsx`.
6. Test Manager reviews and signs
   `05-execution/02-automation-assessment/automation-assessment-review-<scope>.docx`.
